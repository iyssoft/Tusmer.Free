                            ...
                            <View style={CongratulationStyles.minflexview}>
                                <View style={CongratulationStyles.minviewsigninscreen}>
                                    <View style={CongratulationStyles.succefullimgviewtwo}>
                                        <Image style={CongratulationStyles.succefullyimg} resizeMode="contain" source={images.Successfully_Images} />
                                    </View>
                                    <Spacing space={SH(50)} />
                                    <Text style={CongratulationStyles.accounttext}>{t("photography_Title_57")}</Text>
                                    <Spacing space={SH(30)} />
                                    <Text style={CongratulationStyles.accounttextsuccessfully}>{t("photography_Titles_111")}</Text>
                                    <Spacing space={SH(50)} />
                                    <View style={CongratulationStyles.accountbutton}>
                                        <Button title={t("photography_Titles_2")}
